...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:equiv_notas_prot} Equivalencia de notas en el prototipo.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:matriz_estatica} Configuración de las notas en el estado.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:matriz_fisica} Disposición física de la matriz en memoria.}
	\end{center}
\end{table}
...
Para obtener la mayor velocidad de respuesta sin retrasar al planificador, la función \code{output\_init()} crea una \textbf{hebra} que espera un \textbf{semáforo}. \code{output\_metronome()} se limita a enviar una señal a dicho semáforo para despertar a la hebra y hacerla enviar un pulso al zumbador.
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:gpio_struct} Direcciones físicas del GPIO.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:asig_canales} Asignación de pistas al GPIO.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:db_playlist} Tabla playlist.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:db_score} Tabla Score.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:db_shortcut} Tabla Shortcut.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:db_permisos} Permisos sobre la base de datos.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:db_shorcut_tuplas} Datos iniciales de la tabla Shortcut.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|l|l|l|l|}
			...
			\hline 2 & 12 notas & 24 (\textit{Do-1}) & Pedalier \\
			\hline 2 & 26 notas & 60 (\textit{Do-4}) & Registros \\
			\hline 
		\end{tabular}
		\smallskip
		\caption{\label{tab:miditest_map} Asignación de notas en el simulador de reproducción.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:archivos_driver} Relación de módulos en el controlador.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:archivos_admin} Relación de módulos en el administrador.}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
		\smallskip
		\caption{\label{tab:archivos_manager} Archivos de soporte al administrador.}
	\end{center}
\end{table}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\caption{\label{tab:lineas} Recuento de líneas de código.}
\end{center}
\end{table}
\smallskip
