...
\begin{figure}[H]
	\noindent \begin{centering}
		...
		\par\end{centering}
	\smallskip
	\caption{\label{fig:HIRK-433A} Receptor de radio HIRK-433A.}
\end{figure} 
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:info_recv} Características del receptor de mando.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:rapberry} Especificaciones del \textit{Raspberry Pi}.}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_header} Contenido de la cabecera \textit{MIDI}.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_track} Contenido de la cabecera de una pista \textit{MIDI}.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_evento} Especificación de un evento \textit{MIDI}.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_eventos} Eventos \textit{MIDI}.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_mevaevento} Especificación de un meta-evento \textit{MIDI}.}
\end{center}
...
\begin{center}
	...
	\end{tabular}
	\smallskip
	\captionof{table}{\label{tab:midi_mevaevento} Meta-eventos \textit{MIDI}.}
\end{center}
